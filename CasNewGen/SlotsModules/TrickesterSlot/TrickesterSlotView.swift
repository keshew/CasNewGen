...
struct TrickesterSlotView: View {
    @StateObject var viewModel =  TrickesterSlotViewModel()
                    ...
                    HStack(spacing: 35) {
                        VStack(spacing: 0) {
                            ...
                            ZStack(alignment: .leading) {
                                Rectangle()
                                    .fill(LinearGradient(colors: [Color(red: 152/255, green: 84/255, blue: 0/255),
