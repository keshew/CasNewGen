...
struct IntergalacSlotView: View {
    @StateObject var viewModel =  IntergalacSlotViewModel()
                    ...
                    HStack(spacing: 35) {
                        VStack(spacing: 0) {
                            ...
                            ZStack(alignment: .leading) {
                                Rectangle()
                                    .fill(LinearGradient(colors: [Color(red: 0/255, green: 3/255, blue: 152/255),
                                                                  Color(red: 1/255, green: 17/255, blue: 63/255)], startPoint: .top, endPoint: .bottom))
                                    .overlay {
                                    ...
                                    HStack(spacing: 20) {
                                        ForEach(0..<5, id: \.self) { col in
                                            Image(viewModel.slots[row][col])
                                                ...
                                                .shadow(
                                                    color: viewModel.winningPositions.contains(where: { $0.row == row && $0.col == col }) ? Color.purple : .clear,
