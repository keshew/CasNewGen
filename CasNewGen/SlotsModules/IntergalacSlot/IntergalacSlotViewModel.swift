...
class IntergalacSlotViewModel: ObservableObject {
    @Published var slots: [[String]] = []
    @Published var coin =  UserDefaultsManager.shared.coins
    @Published var bet = 100
    let allFruits = ["galact1", "galact2", "galact3", "galact4", "galact5", "galact6"]
    ...
    let symbolArray = [
        Symbol(image: "galact1", value: "100"),
        Symbol(image: "galact2", value: "50"),
        Symbol(image: "galact3", value: "25"),
        Symbol(image: "galact4", value: "15"),
        Symbol(image: "galact5", value: "10"),
        Symbol(image: "galact6", value: "5")
    ]
