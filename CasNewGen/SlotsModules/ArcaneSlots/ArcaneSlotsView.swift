...
struct ArcaneSlotsView: View {
    @StateObject var viewModel =  ArcaneSlotsViewModel()
                    ...
                    HStack(spacing: 35) {
                        VStack(spacing: 0) {
                            ...
                            ZStack(alignment: .leading) {
                                Rectangle()
                                    .fill(LinearGradient(colors: [Color(red: 237/255, green: 132/255, blue: 2/255),
                                                                  Color(red: 63/255, green: 19/255, blue: 1/255)], startPoint: .top, endPoint: .bottom))
                                    .overlay {
                    ...
                    ForEach(0..<3, id: \.self) { row in
                        HStack(spacing: 0) {
                            ForEach(0..<5, id: \.self) { col in
                                Rectangle()
                                    .fill(LinearGradient(colors: [Color(red: 107/255, green: 55/255, blue: 7/255),
                                                                  Color(red: 204/255, green: 88/255, blue: 4/255)], startPoint: .topLeading, endPoint: .bottomTrailing))
                                    .overlay {
                                        RoundedRectangle(cornerRadius: 14)
                                            .stroke(Color(red: 254/255, green: 152/255, blue: 0/255), lineWidth: 1)
                                            .overlay(
