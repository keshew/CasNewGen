...
class QuinSlotViewModel: ObservableObject {
    @Published var slots: [[String]] = []
    @Published var coin =  UserDefaultsManager.shared.coins
    @Published var bet = 100
    let allFruits = ["queen1", "queen2", "queen3", "queen4", "queen5", "queen6"]
    ...
    let symbolArray = [
        Symbol(image: "queen1", value: "100"),
        Symbol(image: "queen2", value: "50"),
        Symbol(image: "queen3", value: "25"),
        Symbol(image: "queen4", value: "15"),
        Symbol(image: "queen5", value: "10"),
        Symbol(image: "queen6", value: "5")
    ]
